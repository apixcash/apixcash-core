...
rm -rf ~/apixcash ~/sign ~/release

git clone https://github.com/apxproject/apixcash.git
cd ~/apixcash
chmod -R +x *
git checkout $BRANCH
...
mkdir -p ~/apixcash/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/apixcash/depends/SDKs/MacOSX10.11.sdk.tar.gz
