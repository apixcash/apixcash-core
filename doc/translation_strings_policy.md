...
This document provides guidelines for internationalization of the Apixcash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `apixcash_en.ts` remains unchanged.
