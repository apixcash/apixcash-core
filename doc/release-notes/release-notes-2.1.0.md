Apixcash Core version *2.1.0* is now available!!
==============

  <https://github.com/ApixcashProject/Apixcash/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/ApixcashProject/Apixcash/commits/release_2.1.0>
