Apixcash Core version *2.0.4.0* is now available!!
==============

  <https://github.com/ApixcashProject/Apixcash/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/ApixcashProject/Apixcash/commits/release_2.0.4>
