...
# TestNode: A peer we use to send messages to apixcashd, and store responses.
...
class CompactBlocksTest(ApixcashTestFramework):
    ...
    # This test actually causes apixcashd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that apixcashd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for apixcashd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # apixcashd will not send blocktxn responses for blocks whose height is
