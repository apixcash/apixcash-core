...
class AssetTest(ApixcashTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("APIXCASH1", 1000)
        n0.issue("APIXCASH2", 1000)
        n0.issue("APIXCASH3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="APIXCASH*", verbose=False, count=2, start=-2)
        ...
        apixcash_assets = n0.listassets(asset="APIXCASH*", verbose=False, count=2, start=-2)
        assert_equal(len(apixcash_assets), 2)
        assert_equal(apixcash_assets[0], "APIXCASH2")
        assert_equal(apixcash_assets[1], "APIXCASH3")
        self.sync_all()
