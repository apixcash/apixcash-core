...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ApixcashTestFramework
    pass

class ExampleTest(ApixcashTestFramework):
    # Each functional test is a subclass of the ApixcashTestFramework class.
    ...
    def custom_method(self):
        ...
        ApixcashTestFramework class so other tests can use it."""
