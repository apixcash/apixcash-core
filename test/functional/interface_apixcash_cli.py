...
class TestApixcashCli(ApixcashTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `apixcash-cli getinfo`")
        ...
        self.log.info("Compare responses from `apixcash-cli -getinfo` and the RPCs data is retrieved from.")
