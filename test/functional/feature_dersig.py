...
class BIP66Test(ApixcashTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # apixcashd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and apixcashd produces more specific reject
            # reasons.
