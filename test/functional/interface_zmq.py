...
import os
import struct
from test_framework.test_framework import ApixcashTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest (ApixcashTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that apixcash has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("apixcashd has not been built with zmq enabled.")
