...
class WalletTest(ApixcashTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 APX from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 APX with subtract fee from amount
        ...
        # Sendmany 10 APX with subtract fee from amount
