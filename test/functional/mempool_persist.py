...
By default, apixcashd will dump mempool on shutdown and
...
class MempoolPersistTest(ApixcashTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give apixcashd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent apixcashd from writing mempool.dat to disk. Verify that `savemempool` fails")
