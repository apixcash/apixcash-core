...
class TxnMallTest(ApixcashTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 APX:
        ...
        # First: use raw transaction API to send 1240 APX to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 APX coin each
        ...
        # Node0's balance should be starting balance, plus 50APX for another
        ...
        # Node0's total balance should be starting balance, plus 100APX for 
