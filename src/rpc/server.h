...
#ifndef APIXCASH_RPCSERVER_H
#define APIXCASH_RPCSERVER_H
...
/**
 * Apixcash RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isAPX = true);
