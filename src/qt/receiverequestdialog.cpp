...
#include "config/apixcash-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatApixcashURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ApixcashUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatApixcashURI(info));
}
