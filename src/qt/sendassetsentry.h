...
#ifndef APIXCASH_QT_SENDASSETSENTRY_H
#define APIXCASH_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending apixcashs.
...
#endif // APIXCASH_QT_SENDASSETSENTRY_H
