...
#ifndef APIXCASH_QT_APIXCASHUNITS_H
#define APIXCASH_QT_APIXCASHUNITS_H
...
/** Apixcash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ApixcashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ApixcashUnits(QObject *parent);

    /** Apixcash units.
      @note Source: https://en.apixcash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        APX,
...
typedef ApixcashUnits::Unit ApixcashUnit;

#endif // APIXCASH_QT_APIXCASHUNITS_H
