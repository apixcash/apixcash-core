...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(ApixcashUnits::APX),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(ApixcashUnits::formatWithUnit(unit, balance, false, ApixcashUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ApixcashUnits::formatWithUnit(unit, unconfirmedBalance, false, ApixcashUnits::separatorAlways));
    ui->labelImmature->setText(ApixcashUnits::formatWithUnit(unit, immatureBalance, false, ApixcashUnits::separatorAlways));
    ui->labelTotal->setText(ApixcashUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, ApixcashUnits::separatorAlways));
    ui->labelWatchAvailable->setText(ApixcashUnits::formatWithUnit(unit, watchOnlyBalance, false, ApixcashUnits::separatorAlways));
    ui->labelWatchPending->setText(ApixcashUnits::formatWithUnit(unit, watchUnconfBalance, false, ApixcashUnits::separatorAlways));
    ui->labelWatchImmature->setText(ApixcashUnits::formatWithUnit(unit, watchImmatureBalance, false, ApixcashUnits::separatorAlways));
    ui->labelWatchTotal->setText(ApixcashUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, ApixcashUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("APX")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the APX balance grid from expanding and looking terrible when asset balance is hidden
