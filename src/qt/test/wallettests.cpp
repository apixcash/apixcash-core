...
#include "qt/apixcashamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ApixcashAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_apixcash-qt -platform xcb      # Linux
//     src/qt/test/test_apixcash-qt -platform windows  # Windows
//     src/qt/test/test_apixcash-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ApixcashUnits::formatWithUnit(unit, balance, false, ApixcashUnits::separatorAlways);
    ...
    // Amount input
    ApixcashAmountField* amountInput = receiveCoinsDialog.findChild<ApixcashAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: apixcash:")) != -1);
