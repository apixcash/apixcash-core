...
#ifndef APIXCASH_QT_APIXCASHGUI_H
#define APIXCASH_QT_APIXCASHGUI_H
...
/**
  Apixcash GUI main class. This class represents the main window of the Apixcash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ApixcashGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ApixcashGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ApixcashGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a apixcash wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // APIXCASH_QT_APIXCASHGUI_H
