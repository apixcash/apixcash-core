...
#ifndef APIXCASH_QT_GUIUTIL_H
#define APIXCASH_QT_GUIUTIL_H
...
/** Utility functions used by the Apixcash Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "apixcash:" URI into recipient object, return true on successful parsing
