...
#ifndef APIXCASH_SCRIPT_SCRIPT_H
#define APIXCASH_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Apixcash always counted CHECKMULTISIGs
...
#endif // APIXCASH_SCRIPT_SCRIPT_H
