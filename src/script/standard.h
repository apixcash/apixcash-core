...
#ifndef APIXCASH_SCRIPT_STANDARD_H
#define APIXCASH_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_APIXCASH_ASSET script that carries data
    /** APX END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a apixcash address
 */
...
/**
 * Generate a Apixcash scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // APIXCASH_SCRIPT_STANDARD_H
