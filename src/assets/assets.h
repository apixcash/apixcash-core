...
#ifndef APIXCASH_ASSET_PROTOCOL_H
#define APIXCASH_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_APIXCASH_ASSET APXQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_APIXCASH_ASSET APXO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_APIXCASH_ASSET APXR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_APIXCASH_ASSET APXT
...
#endif //APIXCASH_ASSET_PROTOCOL_H
