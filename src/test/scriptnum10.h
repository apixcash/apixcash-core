...
#ifndef APIXCASH_TEST_SCRIPTNUM10_H
#define APIXCASH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Apixcash Core 0.10.0, for cross-comparison.
 */
public:
