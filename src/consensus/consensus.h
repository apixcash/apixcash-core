...
#ifndef APIXCASH_CONSENSUS_CONSENSUS_H
#define APIXCASH_CONSENSUS_CONSENSUS_H
...
UNUSED_VAR static bool fEnforcedValuesDeployed = false;
...
#endif // APIXCASH_CONSENSUS_CONSENSUS_H
