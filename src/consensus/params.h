...
#ifndef APIXCASH_CONSENSUS_PARAMS_H
#define APIXCASH_CONSENSUS_PARAMS_H
...
enum DeploymentPos
{
    ...
    DEPLOYMENT_ENFORCE_VALUE, // Deployment of asset reissue enforcement of value
...
#endif // APIXCASH_CONSENSUS_PARAMS_H
