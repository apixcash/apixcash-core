 ...
 */
#ifndef APIXCASH_UTIL_H
#define APIXCASH_UTIL_H
...
extern const char *const APIXCASH_CONF_FILENAME;
extern const char *const APIXCASH_PID_FILENAME;
...
{
    std::string s = strprintf("apixcash-%s", name);
